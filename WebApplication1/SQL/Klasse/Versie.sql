...
CREATE TABLE Versie
(
    Versie_id INT not null AUTO_INCREMENT,
...
INSERT INTO Versie (afbeelding_url,isbn, datum, druk, prijs, uitgave_id,uitgever_id)  VALUE ('https://i.ibb.co/3MwC4s7/cover-250x350.jpg','234234','1993-5-9',1,8,8,2);
